...
public class BookingHistory implements DataAccessLayer{
    ...
    @Override
    public ArrayList<Tour> getTourRecord(int TaxiNum){
        return HistoryRecord.get(TaxiNum); 
    }
    
    
private static class BTree<Key extends Comparable<Key>,Value>{
